...
const EMAILJS_CONFIG = {
  serviceId: 'service_k4pmequ', // Replace with your actual EmailJS service ID
  ...
  const contactInfo = [
    {
      icon: Phone,
      title: "Phone",
      primary: "+254 797 005 402",
      secondary: "+254 720 572 793",
    ...
    },
    {
      icon: Mail,
      title: "Email",
      primary: "info@iamkenyanbyblood.org",
      secondary: "derrick@iamkenyanbyblood.org",
